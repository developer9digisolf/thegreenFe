...
export default function RoomsView() {
    ...
    const columns: Column[] = [
        ...
        { key: "status", title: "Status Ruang", width: "150px", align: "center", render: (v: number) => getStatusTag(v) },
        {
            key: "isActive",
            title: "Aktif",
            width: "100px",
    ...
    return (
        <div className="p-4 lg:p-8">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-8">
                <div>
                    <Typography.Title level={2} className="!m-0 text-slate-800 font-extrabold tracking-tight">Master Ruangan</Typography.Title>
                    <Typography.Text className="text-slate-400 font-medium">Kelola kapasitas dan status ketersediaan ruangan treatment</Typography.Text>
                </div>
                <Button 
                    type="primary" 
                    size="large" 
            ...
            <Modal
                ...
                title={
                    <div className="flex items-center gap-4 p-2">
                        ...
                        <div className="flex flex-col">
                            <Typography className="text-xl font-bold text-slate-800 m-0 leading-tight">{formType === "create" ? "Tambah" : formType === "detail" ? "Detail" : "Update"} Ruangan</Typography>
                        ...
                        <Row gutter={[24, 0]} className="mt-6">
                            ...
                            <Col span={24} md={12}>
                                <UseFormItem name="capacity" label="Kapasitas (Orang)" {...itemLayouts} rules={[{ required: true, message: "Kapasitas wajib diisi" }]}>
                                    <InputNumber min={1} max={20} className="w-full h-[46px] rounded-xl flex items-center border-2 border-slate-100" disabled={formType === "detail"} />
                                </UseFormItem>
                            </Col>
                            <Col span={24} md={12}>
                                <UseFormItem name="status" label="Status Ketersediaan" {...itemLayouts}>
                                    <Select className="w-full h-[46px] custom-select" disabled={formType === "detail"} options={[{ label: "Available", value: 0 }, { label: "Occupied", value: 1 }, { label: "Maintenance", value: 2 }]} />
                                </UseFormItem>
                            </Col>
                            <Col span={24}>
                            ...
                            <Col span={24}>
                                <UseFormItem name="isActive" label="Status Aktif" {...itemLayouts}>
                                    <Select className="w-full h-[46px] custom-select" disabled={formType === "detail"} options={[{ label: "Aktif", value: true }, { label: "Nonaktif", value: false }]} />
                                </UseFormItem>
                            </Col>
                            ...
                            <Col span={24} className="mt-8 flex justify-end gap-3 pt-6 border-t border-slate-100">
                                {formType !== "detail" ? (
                                    <>
                                        ...
                                        <Button type="primary" size="large" className="rounded-xl px-10 bg-emerald-500 hover:bg-emerald-600 border-none font-bold text-white h-12 shadow-lg shadow-emerald-500/20 transition-all active:scale-95" onClick={handleSave} loading={saving}>Simpan Ruangan</Button>
                                    </>
                                ) : (
