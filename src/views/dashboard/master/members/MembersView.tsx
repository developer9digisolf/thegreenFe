    ...
    return (
        <div className="p-4 lg:p-8">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-8">
                <div>
                    <Typography.Title level={2} className="!m-0 text-slate-800 font-extrabold tracking-tight">Master Member</Typography.Title>
                    <Typography.Text className="text-slate-400 font-medium">Kelola data pelanggan, saldo credit, dan riwayat member</Typography.Text>
                </div>
                <Button 
                    type="primary" 
                    size="large" 
            ...
            <Modal
                ...
                title={
                    <div className="flex items-center gap-4 p-2">
                        ...
                        <div className="flex flex-col">
                            <Typography className="text-xl font-bold text-slate-800 m-0 leading-tight">{formType === "create" ? "Tambah" : formType === "detail" ? "Detail" : "Update"} Member</Typography>
                        ...
                        <Row gutter={[24, 0]} className="mt-6">
                            ...
                            <Col span={24} md={12}>
                                <UseFormItem name="gender" label="Gender" {...itemLayouts}>
                                    <Select className="w-full h-[46px] custom-select" disabled={formType === "detail"} options={[{ label: "Laki-laki", value: 0 }, { label: "Perempuan", value: 1 }]} />
                                </UseFormItem>
                            </Col>
                            <Col span={24} md={12}>
                                <UseFormItem name="birthDate" label="Tanggal Lahir" {...itemLayouts}>
                                    <DatePicker className="w-full h-[46px] rounded-xl border-2 border-slate-100 bg-slate-50/50" format="YYYY-MM-DD" disabled={formType === "detail"} suffixIcon={<CalendarOutlined className="text-slate-300" />} />
                                </UseFormItem>
                            </Col>
                            <Col span={24} md={12}>
                                <UseFormItem name="status" label="Status Akun" {...itemLayouts}>
                                    <Select className="w-full h-[46px] custom-select" disabled={formType === "detail"} options={[{ label: "Pending", value: 0 }, { label: "Active", value: 1 }, { label: "Inactive", value: 2 }, { label: "Blocked", value: 3 }]} />
                                </UseFormItem>
                            </Col>
                            <Col span={24}>
                            ...
                            <Col span={24} className="mt-12 flex justify-end gap-3 pt-8 border-t border-slate-100">
                                {formType !== "detail" ? (
                                    <>
                                        ...
                                        <Button type="primary" size="large" className="rounded-xl px-10 bg-emerald-500 hover:bg-emerald-600 border-none font-bold text-white h-12 shadow-lg shadow-emerald-500/20 transition-all active:scale-95" onClick={handleSave} loading={saving}>Simpan Member</Button>
                                    </>
                                ) : (
