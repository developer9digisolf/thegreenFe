...
import {
  ICreditPackage,
  ICreateCreditPackageRequest,
  IUpdateCreditPackageRequest,
} from "@afx/interfaces/credit-package.iface";
import {
  CreditPackageGetAllService,
  CreditPackageCreateService,
  CreditPackageUpdateService,
  CreditPackageDeleteService,
} from "@afx/services/credit-package.service";
import {
  ConfirmActionModal,
  ActionPresets,
...
export default function MasterCreditPackages() {
  ...
  const handleSave = async () => {
    ...
    if (!formData.creditAmount || formData.creditAmount < formData.payAmount) {
      message.warning(
        "Jumlah kredit harus lebih besar atau sama dengan jumlah bayar",
      );
      return;
    }
    ...
    try {
      if (selectedPackage) {
        ...
        const res = await CreditPackageUpdateService(
          selectedPackage.id,
          payload,
        );
        if (res.success) {
  ...
  return (
    <>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Kelola paket top-up kredit untuk member
          </p>
        </div>
        <button
              ...
              {loading ? (
                ...
                packages.map((pkg) => (
                  ...
                  >
                    ...
                    <td
                      className="px-6 py-4 font-extrabold text-emerald-700"
                      suppressHydrationWarning
                    >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex flex-col">
                        <span
                          className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-orange-50 text-orange-600 text-xs font-bold w-fit"
                          suppressHydrationWarning
                        >
      ...
      >
        ...
        <div
          className={`relative bg-white rounded-3xl w-full max-w-lg shadow-2xl overflow-hidden transition-all duration-300 transform ${
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-bold text-slate-700 mb-2 pl-1">
                    Kode Paket{" "}
                    <span className="text-slate-400 font-normal text-[10px] uppercase ml-1">
                      (Opsional)
                    </span>
                  </label>
                  <input
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Space.Compact className="w-full !rounded-xl">
                    <div className="flex items-center px-3 bg-slate-50 border border-slate-200 border-r-0 rounded-l-xl font-bold text-slate-500">
                      Rp
                    </div>
                    <InputNumber
                      min={0}
                      ...
                      className="!rounded-r-xl !bg-slate-50 !border-slate-200 focus-within:!ring-2 focus-within:!ring-[#3d6b5f]/20 focus-within:!border-[#3d6b5f]"
                      formatter={(value) =>
                ...
                <div>
                  ...
                  <Space.Compact className="w-full !rounded-xl">
                    <div className="flex items-center px-3 bg-slate-50 border border-slate-200 border-r-0 rounded-l-xl font-bold text-emerald-600">
                      Rp
                    </div>
                    <InputNumber
                      ...
                      onChange={(value) =>
                        setFormData({
                          ...formData,
                          creditAmount: value || formData.payAmount,
                        })
                      }
                      className="!rounded-r-xl !bg-slate-50 !border-slate-200 focus-within:!ring-2 focus-within:!ring-[#3d6b5f]/20 focus-within:!border-[#3d6b5f]"
                      formatter={(value) =>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Space.Compact className="w-full !rounded-xl">
                    <InputNumber
                      ...
                      className="!rounded-l-xl !bg-slate-50 !border-slate-200 focus-within:!ring-2 focus-within:!ring-[#3d6b5f]/20 focus-within:!border-[#3d6b5f]"
                    />
                    <div className="flex items-center px-3 bg-slate-50 border border-slate-200 border-l-0 rounded-r-xl text-slate-400 font-bold">
                      hari
                    </div>
                  </Space.Compact>
                </div>
                <div>
                  ...
                  <InputNumber
                    ...
                    onChange={(value) =>
                      setFormData({ ...formData, sortOrder: value || 0 })
                    }
